    ...
    <div className=" p-6 min-h-screen  mx-auto bg-gray-100 dark:bg-black px-4 py-12 space-y-10">
      ...
      <div className="max-w-4xl mx-auto space-y-8 ">
        ...
        <Card className="dark:bg-zinc-900">
          ...
          <CardContent className="space-y-4 text-base leading-relaxed">
            <p>
              ...
              errants, abandonnés ou maltraités. 💔 Nous leur offrons une
              nouvelle chance en les soignant, les stérilisant, les identifiant,
              et en leur trouvant un foyer aimant. 🏡
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                les relations avec les adoptants, et les liens avec les
                structures partenaires. 📋
              </li>
              <li>
                Une gestion active de notre communication sur les réseaux
                sociaux, notre site web et notre identité visuelle, pour
                sensibiliser et faire connaître notre mission. 🌐📸
              </li>
            </ul>
            <p>
        ...
        <Card className="dark:bg-zinc-900">
          ...
          <CardContent className="space-y-4">
            <p>
              ...
              identifier, et, dans la mesure du possible, leur trouver une
              famille bienveillante. 💉🐈‍⬛🤝
            </p>
            <p>
              Nous mettons un point d’honneur à créer des rencontres
              harmonieuses entre chaque chat et son futur adoptant. Nous croyons
              que chaque humain et chaque chat peuvent se trouver et partager
              une belle histoire d’amour et de complicité. 💞
            </p>
            <p>
              Nous intervenons principalement dans les communes de la{" "}
              <strong>CCPH</strong> (Communauté de Communes du Pays Houdanais),
              en nous concentrant actuellement sur la commune de{" "}
        ...
        <Card className="dark:bg-zinc-900">
          ...
          <CardContent className="space-y-4">
            <p>
              Nos familles d'accueil jouent un rôle fondamental. Elles offrent
              aux chats recueillis un foyer temporaire, de l'affection et les
              soins nécessaires pour qu'ils puissent se reconstruire. Grâce à
              elles, de nombreux chats craintifs ou traumatisés retrouvent
              confiance et s’épanouissent avant d’être adoptés. 🌼
            </p>
            <p>
        ...
        <Card className="dark:bg-zinc-900">
          ...
          <CardContent className="space-y-4">
            <p>
              Chaque adoption est réfléchie et accompagnée. Un chat adopté est
              un chat suivi, préparé et aimé. Nos familles d’accueil et notre
              équipe veillent à leur bien-être et à leur intégration dans leur
              nouveau foyer. L’adoption responsable est au cœur de notre
              engagement. 🌟
            </p>
          </CardContent>
        </Card>
