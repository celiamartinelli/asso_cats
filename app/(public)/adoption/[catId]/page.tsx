...
export default async function CatIdPage({ params }: CatIdPageProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-screen ">
      ...
      {/* <Button asChild className="mb-2">
        <Link href={`/adoption/${catData.cat_id}`}>
          J'adopte
        </Link>
      </Button> */}
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              <section className="mb-5">
                ...
                <p>
                  Chaque adoption est une chance offerte à un animal de trouver
                  un foyer aimant. Derrière chaque chat confié par l’École des
                  Chats du Pays Houdanais, il y a une histoire : l’abandon, la
                  maltraitance, ou la rue. En ouvrant votre cœur et votre maison
                  à l’un de nos protégés, vous participez à une belle mission :
                  offrir une nouvelle vie remplie de bonheur et de sécurité.
                </p>
                <p>
                  <strong>
                    Mais adopter, c’est aussi un engagement à long terme.
                  </strong>{" "}
                  Un chat peut partager votre vie pendant 15 à 20 ans, avec ses
                  joies, ses besoins, et parfois ses défis. Avant de prendre
                  cette décision, nous vous invitons à bien réfléchir et à vous
                  assurer que vous êtes prêt à accueillir un compagnon à quatre
                  pattes pour de nombreuses années.
                </p>
              </section>
              ...
              <section className="mb-5">
                ...
                <ul className="list-disc list-inside mb-5">
                  ...
                  <li>
                    S’acquitter des frais d’adoption, qui couvrent les dépenses
                    engagées par l’association pour le sauvetage de l’animal
                    (frais vétérinaires, nourriture, etc.).
                  </li>
                  <li>
                    S’engager à stériliser/castrer l’animal avant ses 6 mois, si
                    cela n’a pas déjà été fait par l’association. Un chèque de
                    caution de 200 € sera demandé lors de l’adoption. Ce chèque
                    sera restitué une fois que nous aurons reçu une attestation
                    ou facture de votre vétérinaire confirmant la
                    stérilisation/castration.
                  </li>
                  <li>
                    Donner régulièrement des nouvelles (bonnes ou mauvaises) sur
                    la vie du chat après son adoption.
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    <strong>Engagement à vie</strong>: L’adoption d’un chat est
                    un acte sérieux. Vous vous engagez à lui offrir un foyer
                    sécurisé et tout ce dont il a besoin pour vivre heureux et
                    en bonne santé.
                  </li>
                  <li>
                    <strong>Responsabilité vétérinaire</strong>: Tous nos chats
                    sont remis avec un certificat vétérinaire attestant de leur
                    bonne santé. Les frais d'adoption incluent une partie des
                    soins vétérinaires (stérilisation, identification, et
                    antiparasitaires). Les futurs soins et suivi restent à votre
                    charge.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    de votre pièce d’identité et un justificatif de domicile de
                    moins de 3 mois sont nécessaires pour valider votre
                    adoption.
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-5">
                ...
                <ul>
                  ...
                  <li>
                    Donner des nouvelles régulières, accompagnées de photos, au
                    minimum tous les trois mois durant la première année.
                  </li>
              ...
              <section className="mb-5">
                ...
                <ul>
                  <li>
                    Les frais d'adoption sont <strong>non remboursables</strong>
                    , même en cas de retour exceptionnel de l’animal.
                  </li>
                  <li>
              ...
              <section className="mb-5">
                ...
                <ol>
                  ...
                  <li>
                    <strong>Rencontre avec les chats</strong>: Venez rencontrer
                    nos protégés pour découvrir celui qui saura conquérir votre
                    cœur.
                  </li>
                  <li>
                    <strong>Validation</strong>: Après acceptation, vous
                    signerez le contrat d’adoption et accueillerez votre nouveau
                    compagnon.
                  </li>
                </ol>
              </section>
              <div className="items-top flex space-x-2">
                ...
                <div className="grid gap-1.5 leading-none">
                  ...
                  <p className="text-sm text-muted-foreground">
                    En cochant cette case, vous reconnaissez avoir lu et accepté
